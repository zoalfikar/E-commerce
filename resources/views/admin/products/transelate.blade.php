                ...
                <div class="row">
                    <div class="col-md-6 mb-3 ">
                        <select name="cat_id" class="form-select form-select-lg mb-3" aria-label="Default select example">
                            <option selected>{{$transcategory->name}}</option>
                          </select>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="name">name</label>
                        <input placeholder="{{$product->name}}" type="text" class="form-control" name="name" >
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_title" placeholder="{{$product->meta_title}}">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <input type="submit"  value="translate" class="btn btn-primry">
