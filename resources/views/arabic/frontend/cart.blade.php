        ...
        @if (count($cartIteams)>0)
            <div class="card shadow ">
                <div class="card-body">
                    ...
                    @foreach ($cartIteams as $item)
                        ...
                        <div class="row  product_data">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-danger delet-cart-item"><i class="fa fa-trash"></i> ازالة</button>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{url('checkout')}}" class="btn btn-outline-success float-end">الدفع</a>
                </div>
            </div>
        @else
            <div class="card text-center">
                <h2> <i class="fa fa-shopping-cart"></i> بطاقتك فراغة</h2>
