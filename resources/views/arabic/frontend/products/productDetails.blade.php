...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" form="rate-form">ارسل التقييم</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="background-color: bisque">
        <a href="{{url('/showCategories')}}">الفئات</a>/
    ...
    <div class="container mt-5">
        <div class="card product_data">
            <div class="card-header">
                ...
                <label style="font-size: 16px; background-color:rgb(7, 211, 194)" class="float-end"> &nbsp; شائع &nbsp; </label>
            @endif
            </div>
            <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div style="position: relative; padding-left:1cm"  class="col-lg-7 col-md-6 col-sm-6 ">
                        <h4 class="box-title mt-2">الوصف</h4>
                        ...
                        @if ($product->qty>0)
                            <button class="  mt-4 addToCartBtn btn btn-dark btn-rounded mr-1" data-toggle="tooltip" title="" data-original-title="Add to cart">
                                <i class="fa fa-shopping-cart"></i> اضف الى البطاقة
                            </button>
                         @endif
                        <button class=" mt-4 btn btn-primary btn-rounded addToWishlis">
                            <i class="fa fa-heart"></i>اضف الى السلة
                        </button>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6 mt-3 content-center">
                        ...
                        <h5>تقييم</h4>
                        <span style="color: rgb(109, 0, 182)" >{{$numberOfRatings}}</span>&nbsp; الاشخاص الذين قيمو هذا المنج
                        <br>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            قيم هذا المنتج <span><i class="fa fa-star"></i></span>
                        </button>
                        <br>
                        <a href="{{url('add-reviw/'.$product->slug.'/user-review')}}" class="btn btn-primary">اضف مراجعة</a>
                        <a href="{{url('add-complain/'.$product->id)}}" class="btn btn-danger">
                            قدم شكوى عن هذا المنتج
                        </a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h3 class="box-title mt-5">معلومات اضافية</h3>
                        <div class="table-responsive">
                            <table class="table table-striped table-product">
                                <tbody>
                                    <tr>
                                        <td width="390">ضريبة</td>
                                        <td>{{$product->tax}}</td>
                                    </tr>
                                    <tr>
                                        <td width="390">الكمية الموجودة في المتجر</td>

                                        @if ($product->qty>0)
                                            <td>instock</td>
                                        @else
                                            <td class="badge bg-danger">الكمية قد نفذت</td>
                                        @endif
